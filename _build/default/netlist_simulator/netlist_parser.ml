...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | NAND
    | NAME of (
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 25 "netlist_simulator/netlist_parser.ml"
  )
    | MUX
    | INPUT
    | IN
    ...
    | EOF
    | CONST of (
# 26 "netlist_simulator/netlist_parser.mly"
       (string)
# 35 "netlist_simulator/netlist_parser.ml"
  )
    | CONCAT
    | COMMA
    | COLON
...
# 1 "netlist_simulator/netlist_parser.mly"
...
# 117 "netlist_simulator/netlist_parser.ml"
...
# 53 "netlist_simulator/netlist_parser.mly"
                    ( Ebinop(Xor, x, y) )
# 143 "netlist_simulator/netlist_parser.ml"
         in
    ...
    | MenhirState30 ->
        ...
        let _v : (Netlist_ast.exp) = 
# 64 "netlist_simulator/netlist_parser.mly"
     ( Eslice (min, max, x) )
# 153 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState33 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _v : (Netlist_ast.exp) = 
# 62 "netlist_simulator/netlist_parser.mly"
     ( Eselect (idx, x) )
# 163 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState37 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _v : (Netlist_ast.exp) = 
# 56 "netlist_simulator/netlist_parser.mly"
    ( Erom(addr, word, ra) )
# 173 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState43 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState46 ->
        ...
        let _v : (Netlist_ast.exp) = 
# 58 "netlist_simulator/netlist_parser.mly"
    ( Eram(addr, word, ra, we, wa, data) )
# 222 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState48 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState49 ->
        ...
        let (((_menhir_stack, _menhir_s), _, (x : (Netlist_ast.arg))), _, (y : (Netlist_ast.arg))) = _menhir_stack in
        let _v : (Netlist_ast.exp) = 
# 51 "netlist_simulator/netlist_parser.mly"
                   ( Ebinop(Or, x, y) )
# 245 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState51 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _v : (Netlist_ast.exp) = 
# 48 "netlist_simulator/netlist_parser.mly"
              ( Enot x )
# 255 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState53 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState54 ->
        ...
        let (((_menhir_stack, _menhir_s), _, (x : (Netlist_ast.arg))), _, (y : (Netlist_ast.arg))) = _menhir_stack in
        let _v : (Netlist_ast.exp) = 
# 52 "netlist_simulator/netlist_parser.mly"
                     ( Ebinop(Nand, x, y) )
# 278 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState56 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState58 ->
        ...
        let _v : (Netlist_ast.exp) = 
# 54 "netlist_simulator/netlist_parser.mly"
                          ( Emux(x, y, z) )
# 314 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState60 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState61 ->
        ...
        let (((_menhir_stack, _menhir_s), _, (x : (Netlist_ast.arg))), _, (y : (Netlist_ast.arg))) = _menhir_stack in
        let _v : (Netlist_ast.exp) = 
# 60 "netlist_simulator/netlist_parser.mly"
     ( Econcat(x, y) )
# 337 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState63 ->
        let _menhir_stack = Obj.magic _menhir_stack in
    ...
    | MenhirState64 ->
        ...
        let (((_menhir_stack, _menhir_s), _, (x : (Netlist_ast.arg))), _, (y : (Netlist_ast.arg))) = _menhir_stack in
        let _v : (Netlist_ast.exp) = 
# 50 "netlist_simulator/netlist_parser.mly"
                    ( Ebinop(And, x, y) )
# 360 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | MenhirState22 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _v : (Netlist_ast.exp) = 
# 47 "netlist_simulator/netlist_parser.mly"
          ( Earg a )
# 370 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 232 "<standard.mly>"
    ( xs )
# 394 "netlist_simulator/netlist_parser.ml"
...
# 232 "<standard.mly>"
    ( xs )
# 402 "netlist_simulator/netlist_parser.ml"
              
            in
            let inp = 
# 232 "<standard.mly>"
    ( xs )
# 408 "netlist_simulator/netlist_parser.ml"
             in
            
# 41 "netlist_simulator/netlist_parser.mly"
    ( { p_eqs = eqs; p_vars = Env.of_list vars; p_inputs = inp; p_outputs = out; } )
# 413 "netlist_simulator/netlist_parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 213 "<standard.mly>"
    ( x :: xs )
# 432 "netlist_simulator/netlist_parser.ml"
         in
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 446 "netlist_simulator/netlist_parser.ml"
    ))) = _menhir_stack in
    let _v : (Netlist_ast.equation) = 
# 44 "netlist_simulator/netlist_parser.mly"
                     ( (x, e) )
# 451 "netlist_simulator/netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
# 243 "<standard.mly>"
    ( x :: xs )
# 478 "netlist_simulator/netlist_parser.ml"
         in
...
# 144 "<standard.mly>"
    ( x )
# 488 "netlist_simulator/netlist_parser.ml"
         in
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 497 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 505 "netlist_simulator/netlist_parser.ml"
    )) = _v in
    let _v : (Netlist_ast.arg) = 
# 68 "netlist_simulator/netlist_parser.mly"
            ( Avar id )
# 510 "netlist_simulator/netlist_parser.ml"
     in
...
# 26 "netlist_simulator/netlist_parser.mly"
       (string)
# 517 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 26 "netlist_simulator/netlist_parser.mly"
       (string)
# 525 "netlist_simulator/netlist_parser.ml"
    )) = _v in
    let _v : (Netlist_ast.arg) = 
# 67 "netlist_simulator/netlist_parser.mly"
            ( Aconst (value_of_const n) )
# 530 "netlist_simulator/netlist_parser.ml"
     in
    _menhir_goto_arg _menhir_env _menhir_stack _menhir_s _v
...
# 211 "<standard.mly>"
    ( [] )
# 539 "netlist_simulator/netlist_parser.ml"
     in
    _menhir_goto_list_equ_ _menhir_env _menhir_stack _menhir_s _v
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 546 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 679 "netlist_simulator/netlist_parser.ml"
                )) = _v in
                let (_menhir_stack, _menhir_s) = _menhir_stack in
                let _v : (Netlist_ast.exp) = 
# 49 "netlist_simulator/netlist_parser.mly"
               ( Ereg x )
# 685 "netlist_simulator/netlist_parser.ml"
                 in
                _menhir_goto_exp _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                assert (not _menhir_env._menhir_error);
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 767 "netlist_simulator/netlist_parser.ml"
    ))) = _menhir_stack in
    let _v : (string * Netlist_ast.ty) = 
# 70 "netlist_simulator/netlist_parser.mly"
                      ( (x, ty) )
# 772 "netlist_simulator/netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
# 241 "<standard.mly>"
    ( [ x ] )
# 796 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_var_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 26 "netlist_simulator/netlist_parser.mly"
       (string)
# 809 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 26 "netlist_simulator/netlist_parser.mly"
       (string)
# 817 "netlist_simulator/netlist_parser.ml"
    )) = _v in
    let _v : (int) = 
# 76 "netlist_simulator/netlist_parser.mly"
            ( int_of_string c )
# 822 "netlist_simulator/netlist_parser.ml"
     in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState11 ->
...
# 73 "netlist_simulator/netlist_parser.mly"
                ( TBitArray n )
# 833 "netlist_simulator/netlist_parser.ml"
         in
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 954 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
    ...
    | COMMA | IN ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _v : (Netlist_ast.ty) = 
# 72 "netlist_simulator/netlist_parser.mly"
              ( TBit )
# 977 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_ty_exp _menhir_env _menhir_stack _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 142 "<standard.mly>"
    ( [] )
# 1038 "netlist_simulator/netlist_parser.ml"
                 in
                _menhir_goto_loption_separated_nonempty_list_COMMA_var__ _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                assert (not _menhir_env._menhir_error);
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 1064 "netlist_simulator/netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 243 "<standard.mly>"
    ( x :: xs )
# 1069 "netlist_simulator/netlist_parser.ml"
         in
...
# 144 "<standard.mly>"
    ( x )
# 1079 "netlist_simulator/netlist_parser.ml"
         in
...
# 142 "<standard.mly>"
    ( [] )
# 1240 "netlist_simulator/netlist_parser.ml"
     in
    _menhir_goto_loption_separated_nonempty_list_COMMA_NAME__ _menhir_env _menhir_stack _menhir_s _v
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 1247 "netlist_simulator/netlist_parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 27 "netlist_simulator/netlist_parser.mly"
       (string)
# 1270 "netlist_simulator/netlist_parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 241 "<standard.mly>"
    ( [ x ] )
# 1275 "netlist_simulator/netlist_parser.ml"
         in
        _menhir_goto_separated_nonempty_list_COMMA_NAME_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 1331 "netlist_simulator/netlist_parser.ml"
